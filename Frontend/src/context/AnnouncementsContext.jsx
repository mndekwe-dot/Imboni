...
const initialAnnouncements = [
    ...
    { id: 'a2',  source: 'dos',     audience: 'all',      type: 'school',     icon: 'school',            title: 'Term 2 Parent-Teacher Conference on March 20',            date: 'Mar 7, 2026 · 10:00 AM',  body: 'The Term 2 Parent-Teacher Conference will be held on Friday, March 20, 2026 from 8:00 AM to 4:00 PM. Parents are invited to meet with subject teachers to discuss student progress.', author: 'Dr. Ndagijimana (DOS)',                isUnread: true  },
    { id: 'a3',  source: 'teacher', audience: 'students', type: 'class',      icon: 'class',             title: 'S4A Extra Mathematics Revision This Week',                date: 'Mar 6, 2026 · 2:00 PM',   body: 'Mr. Rurangwa will hold extra revision sessions for S4A this week, on Tuesday and Thursday, 3:30 to 5:00 PM in Room 201. Attendance strongly encouraged for upcoming CATs.',  author: 'Mr. Rurangwa (Mathematics)',            isUnread: true  },
    ...
    { id: 'a6',  source: 'admin',   audience: 'all',      type: 'school',     icon: 'local_library',     title: 'Library Extended Hours During Exam Period',               date: 'Feb 28, 2026 · 8:00 AM',  body: 'Library open until 7:00 PM from March 10 to 21. Students must present school ID to access after 4:30 PM.',                                                               author: 'School Administration',                 isUnread: false },
    { id: 'a7',  source: 'dis',     audience: 'students', type: 'activities', icon: 'sports_basketball', title: 'Basketball Match vs. Groupe Scolaire Officiel, Mar 15',   date: 'Feb 25, 2026 · 4:00 PM',  body: 'Girls Basketball Team vs. Groupe Scolaire Officiel on Saturday, March 15 at 10:00 AM on Main Sports Ground. Team members report to Coach Nkurunziza by 8:30 AM.',         author: 'Coach Nkurunziza (Sports)',             isUnread: false },
